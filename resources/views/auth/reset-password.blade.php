    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-header fw-bold mb-1">Reset Password</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="no_hp" class="col-md-4 col-form-label text-md-end">Nomor HP</label>

                            <div class="col-md-6">
                                <input id="no_hp" type="text" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp" value="{{ old('no_hp', $request->query('no_hp')) }}" required autocomplete="tel" autofocus>
